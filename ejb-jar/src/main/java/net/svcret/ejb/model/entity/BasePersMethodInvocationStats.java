...
@MappedSuperclass
public abstract class BasePersMethodInvocationStats extends BasePersInvocationStats {
	...
	public synchronized void mergeUnsynchronizedEvents(BasePersMethodInvocationStats stats) {
		synchronized (stats) {
	...
	public synchronized void mergeUnsynchronizedEvents(BasePersInvocationStats theStats) {
		BasePersMethodInvocationStats stats = (BasePersMethodInvocationStats) theStats;
