...
public class Queries {
	...
	public static final String MONITORRULE_FINDALL = "BasePersMonitorRule.find";
	public static final String MONITORRULE_FINDALL_Q="SELECT s FROM BasePersMonitorRule s";
