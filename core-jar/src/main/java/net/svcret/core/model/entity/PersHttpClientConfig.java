...
public class PersHttpClientConfig extends BasePersObject {
	...
	public static final int DEFAULT_READ_TIMEOUT_MILLIS = DtoHttpClientConfig.DEFAULT_READ_TIMEOUT;
	public static final UrlSelectionPolicy DEFAULT_URL_SELECTION_POLICY = DtoHttpClientConfig.DEFAULT_URL_SELECTION_POLICY;
	...
	@Column(name = "CONFIG_NAME", nullable = true, length = 200)
