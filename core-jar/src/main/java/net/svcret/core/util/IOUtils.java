...
public class IOUtils {
	...
	public static String readClasspathIntoString(String theResource) throws IOException {
		String retVal = new String(readClasspathIntoByteArray(theResource));
		if (retVal.length() == 0) {
			throw new IllegalArgumentException("Unknown resource: " + theResource);
		}
		return retVal;
	}

	public static InputSource toInputSource(String theText) {
		return new InputSource(new StringReader(theText));
	}
