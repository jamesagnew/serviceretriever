...
public class PEditTextCell extends AbstractEditableCell<String, PEditTextCell.ViewData> implements Cell<String> {
	public static final String NO_VALUE_STRING = "AAAAAAAAAAAAAAAAAAAAZZZZZZZZZZZZAAAAAAAAAAAAA";

	public PEditTextCell(String theNoTextValue) {
		this(new MyRenderer(theNoTextValue));
	}

	public PEditTextCell() {
		this(new MyRenderer(null));
	}
	 ...
	 */
	private PEditTextCell(SafeHtmlRenderer<String> renderer) {
	...
	public void render(Context context, String value, SafeHtmlBuilder sb) {
		...
		if (toRender != null && toRender.trim().length() > 0) {
			...
			sb.append(renderer.render(NO_VALUE_STRING));
		}
	}
	...
	private String processEmptyValue(String value) {
		if (value == null || value.equals("") || NO_VALUE_STRING.equals(value)) {
			value = "";
		}
		return value;
	}
	...
	private static class MyRenderer implements SafeHtmlRenderer<String> {

		private String myNoTextValue;

		public MyRenderer(String theNoTextValue) {
			myNoTextValue = theNoTextValue;
		}

		@Override
		public SafeHtml render(String theObject) {
		...
		@Override
		public void render(String theObject, SafeHtmlBuilder theBuilder) {
			theBuilder.appendHtmlConstant("<span class=\"" + CssConstants.EDITABLE_LABEL + "\">");
			if (theObject == NO_VALUE_STRING && myNoTextValue != null) {
				theBuilder.appendEscaped(myNoTextValue);
			} else if (theObject == null) {
				// nothing
			} else {
				theBuilder.appendEscaped(theObject);
			}
			theBuilder.appendHtmlConstant("</span>");
		}
