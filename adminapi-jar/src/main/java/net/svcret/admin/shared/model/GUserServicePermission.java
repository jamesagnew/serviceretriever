...
public class GUserServicePermission extends BaseGObject<GUserServicePermission> {
	...
	/**
	 * @param theServicePid the ServicePid to set
	 */
	...
	/**
	 * @param theAllowAllServiceVersions the allowAllServiceVersions to set
	 */
	...
	/**
	 * @param theServiceVersionPermissions the ServiceVersionPermissions to set
	 */
